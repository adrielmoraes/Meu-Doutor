[Skip to main content](https://docs.livekit.io/agents/build/tools/#main-content)
...
[Overview](https://docs.livekit.io/agents/build/tools/#overview) [Tool definition](https://docs.livekit.io/agents/build/tools/#tool-definition) [Name and description](https://docs.livekit.io/agents/build/tools/#name-and-description) [Arguments](https://docs.livekit.io/agents/build/tools/#arguments) [Return value](https://docs.livekit.io/agents/build/tools/#return-value) [Structured output](https://docs.livekit.io/agents/build/tools/#structured-output) [RunContext](https://docs.livekit.io/agents/build/tools/#runcontext) [Interruptions](https://docs.livekit.io/agents/build/tools/#interruptions) [Adding tools dynamically](https://docs.livekit.io/agents/build/tools/#adding-tools-dynamically) [Creating tools programmatically](https://docs.livekit.io/agents/build/tools/#creating-tools-programmatically) [Creating tools from raw schema](https://docs.livekit.io/agents/build/tools/#creating-tools-from-raw-schema) [Error handling](https://docs.livekit.io/agents/build/tools/#error-handling) [Model Context Protocol (MCP)](https://docs.livekit.io/agents/build/tools/#model-context-protocol-mcp-) [Forwarding to the frontend](https://docs.livekit.io/agents/build/tools/#forwarding) [Agent implementation](https://docs.livekit.io/agents/build/tools/#agent-implementation) [Frontend implementation](https://docs.livekit.io/agents/build/tools/#frontend-implementation) [External tools and MCP](https://docs.livekit.io/agents/build/tools/#external-tools-and-mcp) [Examples](https://docs.livekit.io/agents/build/tools/#examples) [Additional resources](https://docs.livekit.io/agents/build/tools/#additional-resources)
...
You can use the return value to initiate a [handoff](https://docs.livekit.io/agents/build/agents-handoffs/#tool-handoff) to a different Agent within a workflow. Optionally, you can return a tool result to the LLM as well. The tool call and subsequent LLM reply are completed prior to the handoff.
...
[**Structured Output** \\
\\
Handle structured output from the LLM by overriding the \`llm\_node\` and \`tts\_node\`.](https://github.com/livekit/agents/blob/main/examples/voice_agents/structured_output.py)
...
This agent implementation example overrides default behavior with custom logic using the LLM and TTS nodes: [`llm_node`](https://docs.livekit.io/agents/build/nodes/#llm_node) and [`tts_node`](https://docs.livekit.io/agents/build/nodes/#tts_node).
...
[**Long running tools** \\
\\
Interruptions during long-running tools.](https://github.com/livekit/agents/blob/main/examples/voice_agents/long_running_function.py)
...
**MCP Agent** \\
\\
A voice AI agent with an integrated Model Context Protocol (MCP) server for the LiveKit API.](https://github.com/livekit-examples/python-agents-examples/tree/main/mcp)
...
**MCP Agent** \\
\\
A voice AI agent with an integrated Model Context Protocol (MCP) server for the LiveKit API.](https://github.com/livekit-examples/python-agents-examples/tree/main/mcp) [**LiveKit Docs RAG** \\
\\
