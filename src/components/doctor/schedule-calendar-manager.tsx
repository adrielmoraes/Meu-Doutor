        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <div className="lg:col-span-5 space-y-8">
                    {/* Calendar Card */}
                    <Card className="bg-white dark:bg-slate-900 border-none ring-1 ring-slate-200 dark:ring-slate-700 shadow-sm overflow-hidden rounded-2xl">
                        <CardHeader className="pb-2 bg-slate-50 dark:bg-slate-950/50 border-b border-slate-100 dark:border-slate-800">
                            <div className="flex items-center justify-between">
                                <CardTitle className="flex items-center gap-2 text-slate-900 dark:text-slate-50 font-bold text-lg">
                                    <CalendarIcon className="h-5 w-5 text-blue-600" />
                                    Calendário de Consultas
                                </CardTitle>
                                <Badge variant="outline" className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 dark:text-slate-600 font-bold text-xs uppercase tracking-tight">
                        ...
                        <CardContent className="p-4 sm:p-6 lg:p-8">
                            <Calendar
                                ...
                                classNames={{
                                    ...
                                    caption_label: "text-xl font-extrabold text-slate-900 dark:text-slate-50",
                                    nav: "space-x-2 flex items-center",
                                    nav_button: "h-9 w-9 bg-slate-50 dark:bg-slate-950 p-0 opacity-100 hover:bg-blue-600 hover:text-white rounded-full text-slate-600 dark:text-slate-300 dark:text-slate-600 transition-all border border-slate-200 dark:border-slate-700",
                                    nav_button_previous: "absolute left-1",
                                    nav_button_next: "absolute right-1",
                                    table: "w-full border-collapse",
                                    head_row: "flex w-full justify-between mb-4",
                                    head_cell: "text-slate-400 dark:text-slate-500 rounded-md w-11 font-bold text-xs uppercase tracking-widest text-center",
                                    ...
                                    day: "h-11 w-11 p-0 font-bold text-slate-600 dark:text-slate-300 dark:text-slate-600 aria-selected:opacity-100 hover:bg-blue-50 dark:bg-blue-950/30 hover:text-blue-700 rounded-full transition-all duration-200",
                            ...
                            {/* Legend */}
                            <div className="flex items-center justify-center gap-6 mt-8 pt-6 border-t border-slate-100 dark:border-slate-800">
                                <div className="flex items-center gap-2">
                                    <div className="w-3 h-3 rounded-full bg-emerald-500 shadow-sm"></div>
                                    <span className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-tight">Disponível</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <div className="w-3 h-3 rounded-full bg-indigo-500 shadow-sm"></div>
                                    <span className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-tight">Agendado</span>
                                </div>
                                <div className="flex items-center gap-2">
                                    <div className="w-3 h-3 rounded-full bg-slate-900"></div>
                                    <span className="text-xs text-slate-500 dark:text-slate-400 font-bold uppercase tracking-tight">Selecionado</span>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-white dark:bg-slate-900 border-none ring-1 ring-slate-200 dark:ring-slate-700 shadow-sm overflow-hidden rounded-2xl">
                        <CardHeader className="pb-3 border-b border-slate-50">
                            <CardTitle className="flex items-center gap-2 text-slate-900 dark:text-slate-50 text-lg font-bold">
                            ...
                            {upcomingAppointments.length > 0 ? (
                                <div className="space-y-3">
                                    {upcomingAppointments.map((appt) => (
                                        <div
                                            key={appt.id}
                                            className="flex items-center gap-4 p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-700 hover:border-blue-300 hover:bg-blue-50 dark:bg-blue-950/30/50 transition-all cursor-pointer group"
                                            onClick={() => setSelectedCalendarDate(parseISO(appt.date))}
                                        >
                                            <div className="flex-shrink-0 w-14 text-center py-1.5 rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 group-hover:border-blue-200 dark:border-blue-800 shadow-sm">
                                                <div className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-tighter leading-none mb-1">
                                                    {format(parseISO(appt.date), 'MMM', { locale: ptBR })}
                                                </div>
                                                <div className="text-lg font-extrabold text-slate-900 dark:text-slate-50 leading-none">
                                ...
                                <div className="text-center py-10">
                                    ...
                                    <p className="text-slate-500 dark:text-slate-400 font-bold">Nenhuma consulta agendada</p>
                                    <p className="text-sm text-slate-400 dark:text-slate-500 mt-1">Sua agenda está livre por enquanto.</p>
                                </div>
                            )}
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-white dark:bg-slate-900 border-none ring-1 ring-slate-200 dark:ring-slate-700 shadow-sm overflow-hidden rounded-2xl">
                        <CardHeader className="pb-3 border-b border-slate-50">
                            <CardTitle className="flex items-center gap-2 text-slate-900 dark:text-slate-50 font-bold">
                ...
                <div className="lg:col-span-7 space-y-8">
                    <Card className="bg-white dark:bg-slate-900 border-none ring-1 ring-slate-200 dark:ring-slate-700 shadow-sm overflow-hidden rounded-2xl h-full flex flex-col">
                        <CardHeader className="p-6 md:p-8 border-b border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/30">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                <div>
                                    <span className="text-xs font-extrabold text-blue-600 uppercase tracking-widest block mb-1">
                                        Detalhamento do Dia
                                    </span>
                                    <CardTitle className="text-4xl font-extrabold text-slate-900 dark:text-slate-50 tracking-tight capitalize">
                                        {getDateLabel(selectedCalendarDate)}
                                    </CardTitle>
                                    <CardDescription className="text-lg text-slate-500 dark:text-slate-400 font-medium mt-1">
                                        {selectedCalendarDate && format(selectedCalendarDate, "dd 'de' MMMM 'de' yyyy", { locale: ptBR })}
                                    </CardDescription>
                                </div>
                                <div className="flex items-center gap-3">
                                    <div className="flex flex-col items-end">
                                        <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Status Diário</span>
                        ...
                        <CardContent className="flex-1 p-0">
                            {appointmentsForSelectedDate.length > 0 ? (
                                <ScrollArea className="h-full min-h-[500px] p-6 md:p-8">
                                    <div className="space-y-6">
                                        {appointmentsForSelectedDate.map(appt => (
                                            <div
                                                key={appt.id}
                                                className="group flex flex-col md:flex-row md:items-center gap-6 p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 hover:border-blue-200 dark:border-blue-800 hover:shadow-md hover:shadow-blue-50/50 transition-all duration-300"
                                            >
                                                <div className="flex-shrink-0">
                                                    <div className="text-center w-24 py-3 rounded-2xl bg-blue-50 dark:bg-blue-950/30 border border-blue-100 group-hover:bg-blue-600 transition-colors">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex flex-wrap items-center gap-3 mb-2">
                                                        <p className="text-xl font-extrabold text-slate-900 dark:text-slate-50 group-hover:text-blue-700 transition-colors truncate">
                                                            {appt.patientName}
                                                        </p>
                                                        <Badge variant="outline" className="text-[10px] h-6 px-3 bg-slate-50 dark:bg-slate-950 border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 dark:text-slate-600 font-bold uppercase tracking-tight">
                                                            {appt.status}
                                                        </Badge>
                                                    </div>
                                                    <div className="flex items-center gap-4 text-sm text-slate-500 dark:text-slate-400 font-medium whitespace-nowrap overflow-hidden">
                                                ...
                                                <div className="flex items-center gap-3 md:pl-4 border-t md:border-t-0 md:border-l border-slate-100 dark:border-slate-800 pt-4 md:pt-0">
                                ...
                                <div className="flex-1 flex flex-col items-center justify-center p-12 text-center">
                                    <div className="w-24 h-24 rounded-full bg-slate-50 dark:bg-slate-950 flex items-center justify-center mb-6 ring-8 ring-slate-50/50">
                                        <CalendarDays className="h-12 w-12 text-slate-300 dark:text-slate-600" />
                                    </div>
                                    <h3 className="text-2xl font-extrabold text-slate-900 dark:text-slate-50 mb-2">Pausa na Agenda</h3>
